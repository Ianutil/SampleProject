 ...
 * Class name  MenuLeftViewFragment
 * Created by  ianchang on 2018-06-05 10:33:08
 * Last modify date   2018-06-05 10:33:08
 */
...
public class MenuLeftViewFragment extends Fragment implements RefreshRecyclerView.OnRefreshViewListener{
...
//        return super.onCreateView(inflater, container, savedInstanceState);
    ...
    private class MyAdapter extends RecyclerView.Adapter<ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_03, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.item_menu_item.setOnClickListener(new View.OnClickListener() {
