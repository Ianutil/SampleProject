 ...
 * Class name  MenuMoreViewFragment
 * Created by  ianchang on 2018-06-05 10:45:56
...
public class MenuMoreViewFragment extends Fragment implements RefreshRecyclerView.OnRefreshViewListener{
...
//        return super.onCreateView(inflater, container, savedInstanceState);
    ...
    private class MyAdapter extends RecyclerView.Adapter<ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_05, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            holder.item_menu_item_03.setOnClickListener(new View.OnClickListener() {

                @Override
                public void onClick(View v) {
                    holder.item_menu.closeMenu();
                    Toast.makeText(v.getContext(), "关注成功"+position, Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView item_menu_item_03;
        ...
        public ViewHolder(View itemView) {
            ...
            item_menu_item_03 = (TextView)itemView.findViewById(R.id.item_menu_item_03);
        }
    }
}
