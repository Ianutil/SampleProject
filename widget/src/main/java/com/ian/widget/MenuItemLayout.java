 ...
 * Class name  MenuItemLayout
 * Created by  ianchang on 2018-04-28 09:38:53
 * Last modify date   2018-04-28 09:34:11
 */
...
public class MenuItemLayout extends FrameLayout {
     ...
     * 因为在调用 {@link #open()} 或者 {@link #closeMenu()} 的时候，mIsOpen的值已经被改变，但是
    ...
    public interface SwipeListener {
        void onSwipeOpen(MenuItemLayout view);

        void onSwipeClose(MenuItemLayout view);
    }
}
