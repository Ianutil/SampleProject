...
import com.ian.machine.member.BuildConfig;
...
//                .addInterceptor(this)
    ...
    @Override
    public Observable<String> registerMember(@Query("code") String code) {
        return mServiceAPI.registerMember(code);
    }

    @Override
    public Observable<String> searchMember(@Query("code") String code) {
        return mServiceAPI.searchMember(code);
    }
}
