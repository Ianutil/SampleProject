package com.ian.machine.member.dialog;
...
public class MessageDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return (new AlertDialog.Builder(this.getActivity())).setIcon(R.mipmap.icon).setTitle(id_title).setMessage(id_message).setPositiveButton(17039370, new DialogInterface.OnClickListener() {
