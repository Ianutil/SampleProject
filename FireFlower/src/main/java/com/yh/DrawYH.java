...
public class DrawYH extends DrawTopBase {
	...
	private Handler handler = new Handler(){
		...
		private DisplayMetrics metrics = mSurfaceView.getContext().getResources().getDisplayMetrics();
		@Override
		public void handleMessage(Message msg) {
			super.handleMessage(msg);

			double x =  Math.random() * 10000 % mSurfaceView.getMeasuredWidth();
			double y =  Math.random() * 10000 % mSurfaceView.getMeasuredHeight();
...
//			handler.sendEmptyMessageDelayed(0, ((long) Math.random() * 10000 / 600));
