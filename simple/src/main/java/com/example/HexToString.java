...
/**
 * Created by ianchang on 2018/9/11.
 */
...
//        String str = "55 01 12 00 00 00 01 69";
        String str = "5501120000000169";
        System.out.println("------>"+Arrays.toString(toBytes1(str)));
        System.out.println("------>"+bytesToHexFun1(toBytes1(str)));
