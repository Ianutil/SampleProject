...
import com.ian.machine.cart.BuildConfig;
...
//                .addInterceptor(this)
    ...
    @Override
    public Observable<String> testAPP(@Url String url, @Query("deviceId") String deviceId) {
        return mServiceAPI.testAPP(url, deviceId);
    }
}
